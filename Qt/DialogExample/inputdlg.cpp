...
{
    bool ok;
    QString str = QInputDialog::getText(this,tr("标准字符串输入对话框"),tr("请输入姓名："),QLineEdit::Normal,nameLabel2 ->text(),&ok);
    if(ok && !str.isEmpty())
...
void InputDlg::ChangeSex()
{
    ...
    sexItems << tr("男") << tr("女") << tr("非男非女");
    bool ok;
    QString sexItem = QInputDialog::getItem(this,tr("标准条目选择框"),tr("选择性别："),sexItems,0,false,&ok);
